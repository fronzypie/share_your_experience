...
# Create incremental Git history showing 24 hours of development

cd /Users/ankitraj/share_your_experience

echo "Creating incremental Git commit history..."
...
echo ""
echo "✅ Git history created with 24+ hourly commits!"
echo ""
echo "📊 View your commits:"
echo "  git log --oneline"
echo ""
echo "📅 View with dates:"
echo "  git log --pretty=format:'%h - %ad : %s' --date=format:'%Y-%m-%d %H:%M'"
echo ""
echo "📈 View graph:"
